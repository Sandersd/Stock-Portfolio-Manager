<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeClients.aspx.cs" Inherits="PortfolioManagement.EmployeeClients" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Button ID="btnGet" runat="server" OnClick="btnGet_Click" Text="Get Clients" BorderStyle="Dotted" />
        <asp:Label ID="lblStatus" runat="server" ForeColor="#FF3300"></asp:Label>
        <br />
        <br />
        <asp:GridView ID="ClientsGrid" leftMargin="80dp" runat="server" AutoGenerateColumns="False" DataKeyNames="ClientId" DataSourceID="ClientDataSource" Visible="False">
            <Columns>
        ...
        <asp:SqlDataSource ID="ClientDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:StockPortfolioConnectionString2 %>" SelectCommand="SELECT * FROM [Client]"></asp:SqlDataSource>
