<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeUpdate.aspx.cs" Inherits="PortfolioManagement.EmployeeUpdate" %>
...
<body>
    ...
    <LI> <A HREF="EmployeeDelete.aspx">Delete</A> </LI>
        ...
        <br />
        <asp:Button ID="btnGet" runat="server" OnClick="btnGet_Click" Text="Get Update" BorderStyle="Dotted" />
