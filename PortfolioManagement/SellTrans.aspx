<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SellTrans.aspx.cs" Inherits="PortfolioManagement.SellTrans" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <center><h1 style="padding: inherit; font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif; font-size: 30px; color: #000080; text-transform: none; text-decoration: underline overline blink; text-align: center; letter-spacing: .25em; position: relative; cursor: crosshair;">Sell Transactions</h1>
        <p>&nbsp;</p>
        <p style="font-family: Georgia, 'Times New Roman', Times, serif">Choose an Account</p>
        <p>
            <asp:DropDownList ID="ddAccount" runat="server" DataSourceID="AccountDataSource" DataTextField="AccountNo" DataValueField="AccountNo" AutoPostBack="True" Font-Names="Georgia" BackColor="#99CCFF">
            </asp:DropDownList>
