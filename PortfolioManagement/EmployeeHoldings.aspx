<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeHoldings.aspx.cs" Inherits="PortfolioManagement.EmployeeHoldings" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Button ID="btnGet" runat="server" OnClick="btnGet_Click" Text="Get Holdings" BorderStyle="Dotted" />
        <asp:Label ID="lblStatus" runat="server" ForeColor="#FF3300"></asp:Label>
        <br />
        <br />
        <asp:GridView ID="HoldingsGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="TransId" DataSourceID="HoldingsDataSource" Visible="False" AllowPaging="True">
            <Columns>
