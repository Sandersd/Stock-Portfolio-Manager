<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeNew.aspx.cs" Inherits="PortfolioManagement.EmployeeNew" %>
...
<body>
    ...
    <LI> <A HREF="EmployeeDelete.aspx">Delete</A> </LI>
        ...
        <br />
        <asp:Button ID="btnGet" runat="server" OnClick="btnGet_Click" Text="Get New" BorderStyle="Dotted" />
